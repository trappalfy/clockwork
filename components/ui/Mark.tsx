 ...
 * machine. Decorative by default (aria-hidden): everywhere it's used,
 * the "Clockwork" wordmark sits next to it, so a second announcement
 * would be redundant. Pass ariaLabel to use it standalone (e.g. a
...
export function Mark({
  ...
  return (
    ...
    >
      ...
      />
      {/* Punches the hub back out to paper — both call sites sit on
          --paper, so this is safe to hardcode rather than take as a prop. */}
      <circle cx="100" cy="100" r="20" fill="var(--paper)" />
      ...
      <path
        ...
        fill="none"
      />
      <path fill="currentColor" d="M 200.87 21.20 L 190.03 39.81 L 180.18 27.20 Z" />
      <path
        ...
        fill="none"
      />
      <path fill="currentColor" d="M -0.87 178.80 L 9.97 160.19 L 19.82 172.80 Z" />
    </svg>
  );
}
